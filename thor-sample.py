...
dll_path = r"C:\Program Files\Thorlabs\ThorSpectra\Examples\CompactSpectrometer\Python\pyCCT\net48" #os.path.abspath(os.path.join(os.getcwd(), './pyCCT/net48'))  # Replace with the correct path to your DLL files
